...
<form class="form-horizontal" method="post" action="<?=base_url("products/create_product")?>" enctype="multipart/form-data">
...
<div class="" id="">
  ...
  <div class="span4">
    <div class="">
      ...
      <div class="">
        <input type="text" class="input-xlarge" id="frm-kode" name="kode">
      </div>
    </div>
    <div class="">

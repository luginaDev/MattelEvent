...
class paypal_class {
   ...
   function paypal_class() {
     ...
     $this->paypal_url = 'https://www.paypal.com/cgi-bin/webscr';
      ...
      $this->add_field('cbt','2');           // Return method = POST
   ...
   function submit_paypal_post() {
      ...
      // is redirected to paypal.
       $CI =& get_instance();
       $data["rows"] = $this->fields ;
       $data["url"] = $this->paypal_url;
       $CI->load->view("partials/_paypal_view",$data);
      // echo "<html>\n";
      // echo "<head><title>Proses pembayaran...</title></head>\n";
      // echo "<body onLoad=\"setTimeout(alert(1), 5000);\">\n";
      // echo "<center><h2>Silakan Tunggu beberapa saat.";
      // echo "halaman ini akan dialihkan secara otomatis paypal website.</h2></center>\n";
      // echo "<form method=\"post\" name=\"paypal_form\" target=\"_blank \" ";
      ...
      // echo "<input type=\"submit\" value=\"Click Here\" class='run_paypal'></center>\n";

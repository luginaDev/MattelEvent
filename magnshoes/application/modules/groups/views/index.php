<script>
  $(document).ready(function(){
    ...
    <a class="btn btn-primary" data-toggle="modal" href="#myModal" > 
     <i class="icon-plus-sign icon-white"></i> Group
    </a>    
    <div id="demo">
    <br/>
    ...
    <?php foreach($data[0] as $i => $d): ?>
      <tr>
        ...
        <td>
          <div class="btn-group">
          <a href="#" class="curd_edit btn btn-mini btn-success " id="<?=$d->id?>" >
              <i class="icon-edit icon-white"></i>
          </a>
          <a href="<?=base_url("groups/delete/$d->id")?>" class="btn btn-mini btn-danger">

...
<p><?php  highlight_file($_SERVER['DOCUMENT_ROOT'].'/convert_currency.php'); ?></p>
<p><a href="<?=base_url()?>paypal/convert_currency" target="_blank">Run the code above and see the output.</a></p>
<h2>Pay (Chained)</h2>
...
<p>
  <?php // highlight_file($_SERVER['DOCUMENT_ROOT'].'/quixotik/dzone_doni/application/modules/paypal/includes/pay_chained_demo.php'); ?>
</p>
<p><a href="<?=base_url()?>paypal/pay_chained_demo" target="_blank">Run the code above and see the output.</a></p>
<p>&nbsp;</p>
</body>
</html>
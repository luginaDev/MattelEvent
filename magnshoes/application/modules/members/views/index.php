    ...
    $(".curd_edit").click(function(){
      $.ajax({
        ...
        success : function(data){
          ...
          console.log(jsn);
          jQuery.each(jsn,function(ind,value){
             $("#frm-"+ind).val(value);
             if(ind == "kelurahan_id"){
                val_kelurahan(value);
                val_kecamatan(value);
             ...
             if(ind == "no_ktp"){
               $("#frm-"+ind).attr("readonly","readonly");
             }
             $("#frm-type_proceses").val("update");
          });
          // $("#frm-no_ktp").val(jsn.no_ktp);
        }
      });
...
<div class="modal" id="myModal">
  ...
  <p>
    <div class="control-group">
      ...
      <div class="controls">
        <input type="text" class="input-xlarge required number" id="frm-no_ktp" name="no_ktp">
        <p class="help-block">Masukan No ktp</p>
      </div>
    </div>
    <div class="control-group">
    ...
    <div class="control-group">
      ...
      <div class="controls">
        <textarea class="input-xlarge required" id="frm-alamat" name="alamat"></textarea>
    ...
    <div class="control-group">
      ...
      <div class="controls">
        ...
        <input type="hidden" class="input-xlarge" id="frm-type_proceses" name="type_proceses" value="create">

...
<?php $harga = $this->dh->find( array("detail_produk_id" => $data[0]->id),0,1,"id desc"); ?>
<form class="form-vertical" method="post" action="<?=base_url("products/update_detail_product")?>" enctype="multipart/form-data">
<div class="span5">

 <div class="control-group">
      <label class="control-label" for="nama">Gambar</label>
      <div class="span1 thumbnail" id="thumb-gambar_detail_product">  <img src="<?=base_url()?>assets/uploads/products/<?=$data[0]->gambar?>" alt="<?=$data[0]->nama?>"> </div>
      <div class="controls">
       <input id="file_upload_detail_product" type="file" name="file_upload_detail_product" class="file_upload_detail_product" />
         <input id="frm-gambar_detail_product" type="hidden" name="gambar" value="<?=$data[0]->gambar?>" />
...
<div class="control-group">
  ...
  <div class="controls">
    <input type="text" class="input-xlarge" id="frm-detail_nama" name="nama" value="<?=$data[0]->nama?>" />
    <input type="hidden" class="input-xlarge" id="frm-detail_produk_kode" name="id" value="<?=$data[0]->id?>" >
    <input type="hidden" class="input-xlarge" id="frm-detail_produk_kode" name="produk_kode" value="<?=$data[0]->produk_kode?>" >
...
<div class="control-group">
  ...
  <div class="controls">
    <input type="text" class="input-xlarge" id="frm-detail_warna" name="warna" value="<?=$data[0]->warna?>">
...
<div class="control-group">
  ...
  <div class="controls">
    <input type="text" class="input-xlarge" id="frm-detail_stok" name="stok" value="<?=$data[0]->stok?>">
...
<div class="span4">
 <div class="control-group">
      ...
      <div class="controls">
        ...
        <input type="text" name="berat" id="berat" class="input-xlarge" value="<?=$data[0]->berat?>">
        <!-- <select name="status_produk" id="status_produk" class="input-xlarge">
          <option value="preorder" <?=($data[0]->status_produk=="preorder")? "selected='selected'" : "";?>>preorder</option>
          <option value="stok" <?=($data[0]->status_produk=="stok")? "selected='selected'" : "";?>>stok</option>
        </select> -->
      </div>
    </div>
    <div class="control-group">
      ...
      <div class="controls">
        <input type="text" class="input-xlarge" id="frm-detail_ukuran" name="ukuran" value="<?=$data[0]->ukuran?>">
    ...
    <div class="control-group">
      ...
      <div class="controls">
        ...
        value="<?=(empty($harga[0]->harga))? 0 : $harga[0]->harga ?>">
        <input type="hidden" class="input-xlarge" id="frm-detail_harga" name="harga_lama" 
        value="<?=(empty($harga[0]->harga))? 0 : $harga[0]->harga ?>">

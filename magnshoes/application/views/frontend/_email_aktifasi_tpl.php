                    ...
                    <tbody>
                      ...
                      <tr>
                        ...
                        <td>
                          ...
                          <p style="font-family:Georgia, Tahoma, Arial,Helvetica,sans-serif;font-size:12pt;font-weight:bold;margin-top:0px;margin-bottom:12px; color: #4a4947;">Informasi Aktifasi </p>
                          <p style="font-family:Tahoma, Arial,Helvetica,sans-serif;font-size:9.5pt;margin-top:12px;margin-bottom:12px">Hai <?=$nama?>,</p>
                          <p style="font-family:Tahoma, Arial,Helvetica,sans-serif;font-size:9.5pt;margin-top:12px;margin-bottom:12px">We've changed the payment method information on your account, as you asked. If you'd like to review or change your account information, please visit <a href="#">data member anda</a>.</p>
                          <p>
                            <br/>Nama   : <?=$nama?>
                            <br/> No Telp:<?=$telp?>
                            <br/>Alamat  : <?=$alamat?>
                            ...
                            <br/> Aktifasi link : <?=$link_aktivasi_key?>
                          </p>
                          <p style="font-family:Tahoma, Arial,Helvetica,sans-serif;font-size:9.5pt;margin-top:12px;margin-bottom:0px"> - Your friends at Magnshoes</p>
